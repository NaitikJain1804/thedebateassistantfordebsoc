...
public class MotionsAsian extends Activity {
	   ...
	   public void onCreate(Bundle savedInstanceState) {
		...
		education.setOnClickListener(new View.OnClickListener() {
	           ...
	           public void onClick(View view) {
	        	   Intent format = new Intent("in.apeiro.debateassistant.EDUCATIONAP");
		...
		environment.setOnClickListener(new View.OnClickListener() {
	           ...
	           @Override
	           public void onClick(View view) {
	        	   Intent format = new Intent("in.apeiro.debateassistant.ENVIRONMENTAP");
	   	           startActivity(format);		
	           }
	       });
		...
		freespeech.setOnClickListener(new View.OnClickListener() {
	           ...
	           @Override
	           public void onClick(View view) {
	        	   Intent format = new Intent("in.apeiro.debateassistant.FREESPEECHAP");
	   	           startActivity(format);		
	           }
	       });
		...
		health.setOnClickListener(new View.OnClickListener() {
	           ...
	           @Override
	           public void onClick(View view) {
	        	   Intent format = new Intent("in.apeiro.debateassistant.HEALTHAP");
	   	           startActivity(format);		
	           }
	       });
		...
		law.setOnClickListener(new View.OnClickListener() {
	           ...
	           @Override
	           public void onClick(View view) {
	        	   Intent format = new Intent("in.apeiro.debateassistant.LAWAP");
	   	           startActivity(format);		
	           }
	       });
		...
		mixed.setOnClickListener(new View.OnClickListener() {
	           ...
	           @Override
	           public void onClick(View view) {
	        	   Intent format = new Intent("in.apeiro.debateassistant.MIXEDAP");
	   	           startActivity(format);		
	           }
	       });
		...
		politicsandir.setOnClickListener(new View.OnClickListener() {
	           ...
	           @Override
	           public void onClick(View view) {
	        	   Intent format = new Intent("in.apeiro.debateassistant.POLITICSANDIRAP");
	   	           startActivity(format);		
	           }
	       });
		...
		religion.setOnClickListener(new View.OnClickListener() {
	           ...
	           @Override
	           public void onClick(View view) {
	        	   Intent format = new Intent("in.apeiro.debateassistant.RELIGIONAP");
	   	           startActivity(format);		
	           }
	       });
		...
		society.setOnClickListener(new View.OnClickListener() {
	           ...
	           @Override
	           public void onClick(View view) {
	        	   Intent format = new Intent("in.apeiro.debateassistant.SOCIETYAP");
	   	           startActivity(format);		
	           }
	       });
